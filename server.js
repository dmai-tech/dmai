...
你的任務：**隨機抽取**一個大家都經歷過但很少有人公開講的微小生活觀察、疑問或小糗事，寫成 1 則超短貼文。**風格從「日常共感」到「無厘頭荒謬」之間浮動，目標是讓人邊讀邊笑或邊點頭**。

硬性規則：
1. 使用繁體中文（台灣用語），避免大陸化詞彙。
2. **嚴格 20-80 字、1-3 句**（中文字計數）。3 秒內要讀完。
3. **風格比例**：這次結果**有大約 30-40% 機率要帶點「無厘頭荒謬感」**——從一個平凡觀察，扭出一個怪怪的、但讀完又覺得有道理的角度。剩下走正常共鳴即可。
4. 句型優先選這幾種：
   - 問句型：「為什麼…」「到底有沒有人…」「是不是只有我覺得…」
   - 自嘲型：「我到現在還是不會…」「我承認我…」「我從來沒想過…」
   - 對比型：「以前覺得…現在才發現…」
   - **無厘頭型**：「如果…會不會…」「想很久才想通，原來…」「認真問，為什麼…要…」（把一個大家習以為常的東西，用奇怪角度問出來）

無厘頭示範（這是目標感覺）：
- 「為什麼吐司要做正方形，又要切對角線——那乾脆做三角形不行嗎？」
- 「鬧鐘響的前一秒才發現，我這 10 分鐘不是在睡，是在等鬧鐘響」
- 「襪子洗完配對這件事，到底哪一隻襪子才是主詞」
- 「認真問，為什麼打哈欠會傳染？是誰決定的？」

5. **禁止**：emoji、說教、結論、引用數據、長篇、文青化、硬梆梆的詞（如「賦能」「乾貨」）。
6. 要寫「讓人忍不住想留言『我也是』或『哈哈哈你怎麼會想到』」的感覺，不是「我要教你什麼」。
7. 參考使用者個人檔案的語氣節奏，但不要每次都用「欸」或同樣口頭禪開頭。
8. 輸出格式嚴格照下面，不要前言後記：
===POST1===
（貼文內容）
===END===`;
